						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							...
							<div class="form-group">
									<div class="input-group mb-3">
										...
										<input name="email" type="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Username">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input name="password" type="password" id="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
