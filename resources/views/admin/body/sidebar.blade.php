<aside class="main-sidebar">
    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          <a href="#">
            <i data-feather="package"></i> <span>Kelola Barang</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('barang.view')}}"><i class="ti-more"></i>Tampilkan Daftar Barang</a></li>
            <li><a href="mailbox_compose.html"><i class="ti-more"></i>Tambah Barang</a></li>
          </ul>
        </li>
